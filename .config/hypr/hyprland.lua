...
hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd("mkdir -p " .. screenshotDir .. " && grim " .. screenshotDir .. "/$(date +%Y%m%d-%H%M%S).png"), { description = "[Screenshot] instant full screen, no annotate" })
hl.bind(mainMod .. " + SHIFT + slash", hl.dsp.exec_cmd("kitty kb --search"), { description = "[System] keybind cheatsheet (keybey, searchable)" })
